...
export const EXERCISE_IMAGES: Record<string, ExerciseImage> = {
  ...
  inclineTreadmillWalk: {
    src: "/__l5e/assets-v1/a9e09791-cf70-4145-beb8-f02e7cd6d03d/inclineTreadmillWalk.jpg",
    title: "Incline Treadmill Walk",
    cues: ["Walk tall", "Hands off the rails", "Lower incline if the back complains"],
    equipment: "Treadmill",
  },
  deadBug: {
    src: "/__l5e/assets-v1/77d2c47c-099e-4df5-ae3a-e907ec27468b/deadBug.jpg",
    title: "Dead Bug",
    cues: ["Low back flat", "Exhale as limbs extend", "Slow"],
    equipment: "Bodyweight",
  },
  pallofPress: {
    src: "/__l5e/assets-v1/07e846c4-fded-4bb8-a36d-02ea165b998a/pallofPress.jpg",
    title: "Pallof Press",
    cues: ["Stand side-on", "Resist the twist", "Press straight out"],
    equipment: "Cable or band",
  },
  reverseCrunch: {
    src: "/__l5e/assets-v1/c5da1950-83fe-4546-95dd-7a3608596d72/reverseCrunch.jpg",
    title: "Reverse Crunch",
    cues: ["Curl the pelvis", "No leg swing", "Slow return"],
    equipment: "Bodyweight / mat",
  },
  closeGripPushup: {
    src: "/__l5e/assets-v1/38bfbc0c-3d79-48f0-98a5-3a31366544ce/closeGripPushup.jpg",
  ...
  squatToBench: {
    src: "/__l5e/assets-v1/b7c89341-92d7-4833-a6a1-aaed572b2c7a/squatToBench.jpg",
    title: "Squat to Bench",
    cues: ["Sit back to the bench", "Tap, don't crash", "Drive through mid-foot"],
    equipment: "Bench / box",
  },
  legPress: {
    src: "/__l5e/assets-v1/93069373-eb97-4979-8bee-572bd2d110a7/legPress.jpg",
    title: "Leg Press",
    cues: ["Low back flat on the pad", "Comfortable depth", "No hip curl"],
    equipment: "Leg press machine",
  },
  gobletSquatToBench: {
    src: "/__l5e/assets-v1/cb312e14-5dbf-4e4b-b9fe-06192e740ecf/gobletSquatToBench.jpg",
    title: "Goblet Squat to Bench",
    cues: ["Dumbbell at the chest", "Elbows inside the knees", "Stand tall"],
    equipment: "Dumbbell + bench",
  },
  legCurl: {
    src: "/__l5e/assets-v1/a288712e-992f-4e2f-814e-6b190c352af8/legCurl.jpg",
    title: "Leg Curl",
    cues: ["Hips stay down", "Squeeze the hamstrings", "Slow return"],
    equipment: "Leg curl machine",
  },
  calfRaise: {
    src: "/__l5e/assets-v1/25f5a609-65bc-44c8-92e0-426c5e6e31a4/calfRaise.jpg",
    title: "Standing Calf Raise",
    cues: ["Full stretch at the bottom", "Pause at the top", "No bouncing"],
    equipment: "Machine or step",
  },
  hipThrust: {
    src: "/__l5e/assets-v1/7d5d5b61-8490-4dc8-9001-076c711166b8/hipThrust.jpg",
    title: "Hip Thrust",
    cues: ["Ribs down, chin tucked", "Squeeze at the top", "Pad the bar"],
    equipment: "Bench + barbell / machine",
  },
  hammerCurl: {
    src: "/__l5e/assets-v1/c9ce3bcb-014e-4511-959c-12610d3569cf/hammerCurl.jpg",
    title: "Cross-Body Hammer Curl",
    cues: ["Thumb-up grip", "Curl across the body", "Elbow pinned"],
    equipment: "Dumbbells",
  },
  gluteBridge: {
    src: "/__l5e/assets-v1/855e2d4b-f5de-4c13-a1fa-74a73a5c272c/gluteBridge.jpg",
    title: "Glute Bridge",
    cues: ["Heels close", "Squeeze the glutes", "Ribs down"],
    equipment: "Bodyweight / mat",
  },
  bandPulldown: {
    src: "/__l5e/assets-v1/e87230bc-863a-4ceb-b4e5-8e89b174c798/bandPulldown.jpg",
    title: "Band Pulldown",
    cues: ["Straight arms", "Drive to the thighs", "Chest tall"],
    equipment: "Band anchored high",
  },
  latPulldown: {
    src: "/__l5e/assets-v1/0674db72-0919-4f5c-8c02-e75dce1d56b5/latPulldown.jpg",
    title: "Lat Pulldown",
    cues: ["Chest tall", "Pull to the collarbone", "Control back up"],
    equipment: "Lat pulldown machine",
  },
  seatedRow: {
    src: "/__l5e/assets-v1/cdbda9c2-3f26-4d80-a953-c55884629fab/seatedRow.jpg",
    title: "Seated Cable Row",
    cues: ["Tall torso", "Elbows to the ribs", "No heavy lean-back"],
    equipment: "Cable row machine",
  },
  chestSupportedRow: {
    src: "/__l5e/assets-v1/e609121a-097d-4e82-99e6-8c881b0152d7/chestSupportedRow.jpg",
    title: "Chest-Supported Row",
    cues: ["Chest stays on the pad", "Elbows to the ribs", "Squeeze"],
    equipment: "Incline bench + dumbbells",
  },
  oneArmRow: {
    src: "/__l5e/assets-v1/283d14be-98da-4af4-9aef-81970a0756a2/oneArmRow.jpg",
    title: "One-Arm Supported Row",
    cues: ["Flat back", "Row to the hip", "No twisting"],
    equipment: "Bench + dumbbell",
  },
  rearDeltFly: {
    src: "/__l5e/assets-v1/7346e0c4-3821-40c3-b755-51961b176c8b/rearDeltFly.jpg",
    title: "Rear-Delt Fly",
    cues: ["Light weight", "Soft elbows", "Lead with the pinkies"],
    equipment: "Dumbbells or reverse pec-deck",
  },
  tricepPushdown: {
    src: "/__l5e/assets-v1/e3fa2640-396e-4995-ac22-4ab31c75bfe5/tricepPushdown.jpg",
    title: "Triceps Pushdown",
    cues: ["Elbows pinned", "Full lockout", "Slow return"],
    equipment: "Cable rope or band",
  },
  overheadExtension: {
    src: "/__l5e/assets-v1/05a69afd-aef4-45fb-963f-a73ab15c4c54/overheadExtension.jpg",
  ...
  assistedEccentricCurl: {
    src: "/__l5e/assets-v1/b3c5afea-371a-4e47-b70c-ae7db41a9de3/assistedEccentricCurl.jpg",
    title: "Assisted Eccentric Curl",
    cues: ["Two arms up", "One arm down", "3–5 second lower"],
    equipment: "Dumbbell",
  },
  pjrPullover: {
    src: "/__l5e/assets-v1/5bc9e1bc-84b0-4cdd-a7fc-a3f9326b659a/pjrPullover.jpg",
    title: "PJR Pullover",
